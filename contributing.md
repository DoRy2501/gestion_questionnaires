...
CodeIgniter recommends PHP 7.4 or newer to be used, but it should be
compatible with PHP 7.2 so all code supplied must stick to this
requirement. If PHP 7.3 (and above) functions or features are used then
there must be a fallback for PHP 7.2.
...
The best way to contribute is to "clone" your fork of CodeIgniter to your development area. On GitHub, "forking" creates a copy of the repository in your account, and "cloning" downloads that copy to your local environment for development.

1. Set up Git (Windows, Mac & Linux)
2. Go to the [CodeIgniter repository](https://github.com/bcit-ci/CodeIgniter)
3. Fork it
...
Unlike systems like Subversion, Git can have multiple remotes. A remote is the name for a URL of a Git repository. By default your fork will have a remote named "origin" which points to your fork, but you can add another remote named "codeigniter" which points to `https://github.com/bcit-ci/CodeIgniter.git`. This is a read-only remote but you can pull from this develop branch to update your own.

If you are using command-line you can do the following:

1. `git remote add codeigniter https://github.com/bcit-ci/CodeIgniter.git`
